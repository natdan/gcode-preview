...
//if (vertexNumber < 1000.0)
//{
//    g_color = vec4(0.3, 1.0, 0.3, 1.0);
//}
// else
// {
//    g_color = vec4(0.7, 0.3, 0.3, 0.7);
// }
...
void main() {
    ...
    v_color = a_color;
    if (vertexNumber < u_number) {
        int typ = vertexNumber - (vertexNumber / 10) * 10;
        if (typ == 0) {
            v_color = vec4(1.0, 1.0, 1.0, 0.3);
        } else if (typ == 1) { 
            v_color = vec4(0.3, 1.0, 0.3, 1.0);
        } else {       
        ...
        if (typ == 0) {
            ...
            v_color = vec4(1.0, 0.0, 0.0, 0.3);
        } else {       
            v_color = vec4(1.0, 0.0, 1.0, 0.3);
        }
    }
